...
def r_crypto(u):
    ...
    return u
def r_obfuscate(y):
    y=y.replace("florSFIUEfet4565477","")
    y=y.replace('534345fdfgfgfdhty6y56yjl',"")
    password=str(rtfd.b64decode(y))
...
def main():
    ...
    sik=r_crypto(sik)
    #print(sik)
    password=r_obfuscate(sik)
    print('flag-->',password,sep=' ')
